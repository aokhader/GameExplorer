        ...
        <div className="max-w-4xl mx-auto mt-16 p-8 rounded-2xl bg-white/50 dark:bg-surface-alt/50 backdrop-blur-sm border border-border-strong dark:border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
              ...
              <div className="text-sm font-medium text-fg-subtle dark:text-fg">Mandatory Captures</div>
              <div className="text-xs text-fg-subtle dark:text-fg-muted mt-1">You must jump when a capture is available</div>
            </div>
            <div>
              <div className="text-2xl mb-2">👑</div>
              <div className="text-sm font-medium text-fg-subtle dark:text-fg">King Promotion</div>
              <div className="text-xs text-fg-subtle dark:text-fg-muted mt-1">Reach the back rank to become a king</div>
            </div>
            <div>
              <div className="text-2xl mb-2">🔗</div>
              <div className="text-sm font-medium text-fg-subtle dark:text-fg">Multi-Jump Chains</div>
              <div className="text-xs text-fg-subtle dark:text-fg-muted mt-1">Chain multiple captures in a single turn</div>
            </div>
          </div>
        </div>
      </div>
