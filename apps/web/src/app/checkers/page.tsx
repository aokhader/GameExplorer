          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {gameModes.map((mode, i) => (
              ...
              >
                {mode.available ? (
                  <Link href={mode.href}>
                    <div className="relative overflow-hidden rounded-2xl p-8 h-full bg-surface-alt border border-border surface-raised hover-lift group-hover:[box-shadow:var(--shadow-glow-checkers)]">
