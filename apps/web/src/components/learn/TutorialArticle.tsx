...
const GAME_META: Record<
  TutorialGame,
  { name: string; glowVar: string; hubHref: string; botHref: string }
> = {
  chess: { name: 'Chess', glowVar: '--shadow-glow-chess', hubHref: '/chess', botHref: '/chess/bot' },
  checkers: { name: 'Checkers', glowVar: '--shadow-glow-checkers', hubHref: '/checkers', botHref: '/checkers/bot' },
  reversi: { name: 'Reversi', glowVar: '--shadow-glow-reversi', hubHref: '/reversi', botHref: '/reversi/bot' },
  go: { name: 'Go', glowVar: '--shadow-glow-go', hubHref: '/go', botHref: '/go/bot' },
  liquidate: { name: 'Liquidate', glowVar: '--shadow-glow-liquidate', hubHref: '/liquidate', botHref: '/liquidate/bot' },
};
    ...
    <main className="relative min-h-screen pt-16">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-14">
          ...
          >
            <span className="text-4xl inline-flex items-center"><GameIcon game={tutorial.game} /></span>
          </Reveal>
