...
/**
 * Chess vs bot — the M3 drag/tap board flow with a promotion picker and
 * check-ring. Setup (strength + color + rated) hands off to the in-game shell
 * driven by `useLocalGame`. Bots are capped below 1400 (in-house TS engine);
 * mirrors web's `chess/bot/page.tsx` for the sub-1400 range, reusing the same
 * shared engine, bot, rating math, and `saveGame` writer so results match web.
 */
        ...
        sidebar={
          <>
            <StatusBanner
              ...
              description={gameOverMsg ? undefined : yourTurn ? 'Drag or tap a piece to move.' : undefined}
            />
