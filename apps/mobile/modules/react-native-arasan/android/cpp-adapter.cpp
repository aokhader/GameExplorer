...
Java_com_finesse_arasan_ArasanModule_main(JNIEnv *env, jclass type)
{
    return reactnativearasan::arasan_main();
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_finesse_arasan_ArasanModule_stdinWrite(JNIEnv *env, jclass type, jstring command)
{
    jboolean isCopy;
...
Java_com_finesse_arasan_ArasanModule_stdoutRead(JNIEnv *env, jclass type)
{
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_finesse_arasan_ArasanModule_stderrRead(JNIEnv *env, jclass type)
{
