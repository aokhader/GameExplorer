...
#elif (defined(_MAC) && ((_LIBCPP_STD_VER <= 14) || !defined(_LIBCPP_HAS_ALIGNED_ALLOC))) || defined(__ANDROID__)
// PATCHED for react-native-arasan: Android added to this branch — bionic only
// exposes aligned_alloc from API 28, but this app's minSdk is 24;
// posix_memalign has always existed. (Original branch: older Mac libc++
// lacks std::aligned_alloc.)
extern "C" {
    #include <stdlib.h>
};
